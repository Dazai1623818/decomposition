...
public final class PlotCPQ {
    ...
    private static void runInteractive() {
        ...
        System.out.println("Enter CPQ expressions to plot. Submit an empty line to skip, or Ctrl-D to exit.");
    ...
    private static boolean plotExpression(String originalExpression, int index) {
        ...
        try {
            ...
            System.err.println("Unable to parse CPQ #" + index + " (" + originalExpression + "): " + ex.getMessage());
            return false;
        }
    }
}
