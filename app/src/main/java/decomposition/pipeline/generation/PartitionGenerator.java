 ...
 *
 * <p>Generates: 1) All non-empty, connected, edge-induced subgraphs ("components") of an input CQ
 * edge list; and 2) All edge-disjoint partitions of the entire CQ into such components.
 *
