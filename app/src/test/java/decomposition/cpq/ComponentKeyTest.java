...
final class ComponentKeyTest {
    ...
    void keysAreDeeplyIsolated() {
        ...
        assertEquals(2, keyBits.cardinality(), "Key should have defensive copy, unaffected by mutation");
    }
    ...
    void identicalBitPatternsHaveSameHash() {
        ...
        assertEquals(key1.hashCode(), key2.hashCode(), "Identical bit patterns should hash identically");
    }
